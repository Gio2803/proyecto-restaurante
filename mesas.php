        ...
        <div class="container container-custom">
            ...
            <div class="header-actions">
                ...
                <div class="d-flex gap-2">
                    ...
                    <div class="stats-card">
                        <div class="stats-number" id="reservadas">0</div>
        ...
        $(document).ready(function () {
            ...
            function cargarTablaActivas() {
                $.post("funciones/mesas.php", { funcion: "Tabla" }, function (response) {
                    ...
                    if (!$.fn.DataTable.isDataTable('#mesasTable')) {
                        dataTableActivas = $('#mesasTable').DataTable({
                            language: {
                                ...
                                zeroRecords: "No se encontraron mesas",
                                search: "Buscar:",
                                paginate: {
                                    first: "Primero",
                                    last: "Último",
                    ...
                    Swal.fire("Error", "No se pudo cargar la tabla de mesas", "error");
            ...
            function eliminarMesa(id) {
                Swal.fire({
                    title: '¿Está seguro?',
                    text: "La mesa será eliminada del sistema. ¿Desea continuar?",
                    icon: 'warning',
                    showCancelButton: true,
